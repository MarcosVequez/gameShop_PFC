...
<h1 class="heading">compra por categoría</h1>
   ...
   <a href="category.php?category=Juegos Xbox" class="swiper-slide slide">
      <img src="imagenes/icon_01.png" alt="">
      <h3> Juegos Xbox One/Series</h3>
   </a>

   <a href="category.php?category=Juegos PlayStation" class="swiper-slide slide">
      <img src="imagenes/icon_02.png" alt="">
      <h3> Juegos Sony Ps4/PS5</h3>
   </a>

   <a href="category.php?category=Juegos Switch" class="swiper-slide slide">
      <img src="imagenes/icon_03.png" alt="">
      <h3>Juegos Nintendo Switch</h3>
   </a>

   <a href="category.php?category=Videoconsolas Xbox" class="swiper-slide slide">
      <img src="imagenes/icon_04.png" alt="">
      <h3>Videoconsolas Xbox</h3>
   </a>

   <a href="category.php?category=Videoconsolas PlayStation" class="swiper-slide slide">
      <img src="imagenes/icon_05.png" alt="">
      <h3>Videoconsolas Playstation</h3>
   </a>

   <a href="category.php?category=Videoconsolas Switch" class="swiper-slide slide">
